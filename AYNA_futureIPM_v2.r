...
## UPDATE 28 JULY 2019: included future observed 
...
inits <- function(){list(beta = runif(2, 0.5, 0.99),
                         ...
                         sigma.obs=matrix(runif(n.sites*n.years,1,100),nrow=n.years,ncol=n.sites))}
...
AYNAscenario0 <- jags(jags.data, inits, parameters, "C:\\STEFFEN\\RSPB\\UKOT\\Gough\\ANALYSIS\\PopulationModel\\AYNA_IPM\\AYNA_IPM_v5.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb,parallel=T)
AYNAscenarioM <- jags(jags.data, inits, parameters, "C:\\STEFFEN\\RSPB\\UKOT\\Gough\\ANALYSIS\\PopulationModel\\AYNA_IPM\\AYNA_IPM_v5nomouse.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb,parallel=T)
